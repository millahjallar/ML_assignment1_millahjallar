...
# 2a)
# Want to implemet logistic discriminant classifier and use traning data to train the classifier
...
# Plot training error as a function of epochs and report accuracy
def plot_training_error(learning_rate, num_iterations=1000):
    ...
    # Plot the training error (loss) as a function of epochs
...
# Experimenting with different learning rates and 1000 iterations for each LR
learning_rates = [0.001, 0.01, 0.1, 1] 
num_epochs = 1000

if __name__ == "__main__":
    # Plot the training error for different learning rates
    plt.figure()
